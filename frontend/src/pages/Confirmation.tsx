...
import { KnowBeforeYouGoData } from "../data/KnowBeforeYouGoData";
...
export default function Confirmation() {
  ...
  const knowBeforeYouGoData = KnowBeforeYouGoData[booking?.listing_id ?? ""];
  ...
  if (booking) {
    return (
      <div className="min-h-[100svh] bg-gray-50 pb-24">
        <PWAPopup bottom={77} timeout={1000} bookingPage={true} />
              ...
              {!isAirportTransfer && (
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-gray-800">
                    Chauffeur will be assigned by 11 PM the night before.
                  </p>
                </div>
              )}
              {isAirportTransfer && (
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-sm text-gray-800">
                    Chauffeur will be assigned 3-4 hours before pickup.
                  </p>
                </div>
              )}
              {!isAirportTransfer && (
                <div className="flex items-start gap-2">
                  <i className="ri-map-pin-time-line text-gray-600 text-sm mt-0.5"></i>
                  <p className="text-sm text-gray-800">
                    Chauffeur will be at pickup 30 mins ahead
                  </p>
                </div>
              )}
              {isAirportTransfer && (
                <div className="flex items-start gap-2">
                  <i className="ri-map-pin-time-line text-gray-600 text-sm mt-0.5"></i>
                  <p className="text-sm text-gray-800">
                    Chauffeur will be at pickup 15-30 mins ahead.
                  </p>
                </div>
              )}
              <div className="flex items-start gap-2">
                ...
                <p className="text-sm text-gray-800">
                  Car and chauffeur details will be shared via notification.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-lg font-semibold text-gray-900 mb-3">
                  {isAirportTransfer
                    ? booking?.transfer_type === "Drop to Airport"
                      ? "Drop to KIA (BLR) Airport"
                      : "Pickup from KIA (BLR) Airport"
                    : trip?.title}
                </h4>
                {isAirportTransfer ? (
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-medium text-gray-900">
                        {isAirportTransfer ? "Prime" : booking?.car_type}
                      </p>
                    </div>
                  </div>
                  <div
                    ...
                    ref={
                      activeTooltip === "capacity-tooltip" ? tooltipRef : null
                    }
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-medium text-gray-900">
                        {isAirportTransfer
                          ? "4+1 Seats"
                          : getVehicleSeat(booking?.car_type)}
                      </p>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <span className="text-gray-500 font-medium block mb-1">
                        {isAirportTransfer
                          ? booking?.transfer_type === "Pickup from Airport"
                            ? "Drop Location"
                            : "Pickup Location"
                          : "Pickup Location"}
                      </span>
              ...
              {!isAirportTransfer && (
                <div className="border-t border-gray-100 pt-4">
                  <Link
                    to={`/${hotelId}/trip/${booking?.listing_id}`}
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span
                  className={`text-sm font-medium px-2 py-1 rounded-full ${paymentConfig.bgColor} ${paymentConfig.textColor}`}
                >
                  {paymentConfig.label}
                </span>
              </div>
                    ...
                    <div className="bg-blue-50 p-3 rounded-lg">
                      <div className="flex items-center gap-2 text-blue-800 text-sm">
                        ...
                        <span className="font-medium">
                          Cancel free until 6 PM the day before scheduled tour
                        </span>
                      </div>
                    </div>
                  </>
              ...
              {isAirportTransfer && (
                <div className="border-t border-gray-200 pt-3 space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">
                        Cancel free until 12 hours before pickup
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-2">
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  >
                    ...
                    <i
                      className={`ri-arrow-${
                        expandedSections.essential ? "up" : "down"
                      }-s-line text-gray-500`}
                    ></i>
                  </button>
                  {expandedSections.essential &&
                    knowBeforeYouGoData?.essentialItems && (
                      <div className="px-3 pb-3 bg-gray-50">
                        <div className="space-y-2">
                          {knowBeforeYouGoData.essentialItems.map(
                            (item, index) => (
                              <div
                                key={index}
                              ...
                              >
                                <i
                                  className={`${item.icon} text-green-600 text-xs`}
                                ></i>
                                <span>{item.text}</span>
                              </div>
                            )
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  {expandedSections.accessibility &&
                    knowBeforeYouGoData?.accessibility && (
                      <div className="px-3 pb-3 bg-gray-50">
                        <div className="space-y-2">
                          {knowBeforeYouGoData.accessibility.map(
                            (item, index) => (
                              <div
                                key={index}
                                className="flex items-center gap-2 text-sm text-gray-700"
                              >
                                <i
                                  className={`${item.icon} text-orange-600 text-xs`}
                                ></i>
                                <span>{item.text}</span>
                              </div>
                            )
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  >
                    ...
                    <i
                      className={`ri-arrow-${
                        expandedSections.rules ? "up" : "down"
                      }-s-line text-gray-500`}
                    ></i>
                  </button>
                  {expandedSections.rules &&
                    knowBeforeYouGoData?.rulesRestrictions && (
                      <div className="px-3 pb-3 bg-gray-50">
                        <div className="space-y-2">
                          {knowBeforeYouGoData.rulesRestrictions.map(
                            (item, index) => (
                              <div
                                key={index}
                                className="flex items-center gap-2 text-sm text-gray-700"
                              >
                                <i
                                  className={`${item.icon} text-red-600 text-xs`}
                                ></i>
                                <span>{item.text}</span>
                              </div>
                            )
                ...
                <div className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  >
                    ...
                    <i
                      className={`ri-arrow-${
                        expandedSections.weather ? "up" : "down"
                      }-s-line text-gray-500`}
                    ></i>
                  </button>
                  {expandedSections.weather &&
                    knowBeforeYouGoData?.weatherAdvisory && (
                      <div className="px-3 pb-3 bg-gray-50">
                        <div className="space-y-2">
                          {knowBeforeYouGoData.weatherAdvisory.map(
                            (item, index) => (
                              <div
                                key={index}
                                className="flex items-center gap-2 text-sm text-gray-700"
                              >
                                <i
                                  className={`${item.icon} text-blue-600 text-xs`}
                                ></i>
                                <span>{item.text}</span>
                              </div>
                            )
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 p-4 shadow-lg">
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              onClick={() => navigate(`/${hotelId}/bookings`)}
